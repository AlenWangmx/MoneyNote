...
public class DBOpenHelper extends SQLiteOpenHelper {
    ...
    //创建数据库的方法，只有项目第一次运行时被调用

    @Override
    public void onCreate(SQLiteDatabase db) {
        String sql="create table typetb(id integer primary key autoincrement,typeName varchar(10),ImgID integer,sImgID integer,kind integer)";
        db.execSQL(sql);
        insertType(db);
        //创建记账表
        sql="create table accounttb(id integer primary key autoincrement,typeName varchar(10),sImgID integer,tip varchar(80),money float," +
    ...
    private void insertType(SQLiteDatabase db) {
        //向typetb表当中插入元素
        String sql="insert into typetb (typeName,ImgID,sImgID,kind) values(?,?,?,?)";
        db.execSQL(sql,new Object[]{"其它", R.mipmap.ic_qita,R.mipmap.ic_qita_fs,0});
        ...
        db.execSQL(sql,new Object[]{"服装", R.mipmap.ic_fushi,R.mipmap.ic_fushi_fs,0});
        ...
        db.execSQL(sql,new Object[]{"其它", R.mipmap.in_qt, R.mipmap.in_qt_fs,1});
